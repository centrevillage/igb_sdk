...
#ifndef IGB_STM32_BASE_MCU_DEVICE_STM32F303X8_H
#define IGB_STM32_BASE_MCU_DEVICE_STM32F303X8_H
...
#define STM32_PERIPHGRP_ADC_COMMON_EXISTS 1
#define STM32_PERIPH_ADC_COMMON_EXISTS 1
...
constexpr struct PeriphInfo {
  ...
  const std::array<UsartInfo, 3> usart {
    UsartInfo {
...
#endif /* IGB_STM32_BASE_MCU_DEVICE_STM32F303X8_H */
