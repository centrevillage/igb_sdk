#ifndef IGB_GD32_PERIPH_FAST_GPIO_H
#define IGB_GD32_PERIPH_FAST_GPIO_H
...
struct FastGpioPort {
  ...
  constexpr static auto info = GD32_PERIPH_INFO.gpio[to_idx(type)];
  constexpr static auto addr = GD32_PERIPH_INFO.gpio[to_idx(type)].addr;
...
#endif
  constexpr static auto addr_TG = IGB_GPIO_REG_ADDR(TG);
...
#endif /* IGB_GD32_PERIPH_FAST_GPIO_H */
