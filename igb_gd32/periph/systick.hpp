#ifndef IGB_GD32_PERIPH_SYSTICK_H
#define IGB_GD32_PERIPH_SYSTICK_H
...
// if you use systick callback, please define USER_SYSTICK_HANDLER_CALLBACK macro in "igb_gd32_user_conf.h"
...
static IGB_FAST_INLINE uint32_t current_msec() {
  return igb::gd32::SystickCtrl::getCurrentMilliSec();
}

static IGB_FAST_INLINE uint32_t current_usec() {
  return igb::gd32::SystickCtrl::getCurrentMicroSec();
}
...
#endif /* IGB_GD32_PERIPH_SYSTICK_H */
